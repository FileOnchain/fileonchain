...
config :fileonchain, FileonchainWeb.Endpoint,
  ...
  pubsub_server: Fileonchain.PubSub,
  live_view: [signing_salt: "Xa+byBP0"]
...
config :fileonchain, Fileonchain.Mailer, adapter: Swoosh.Adapters.Local
